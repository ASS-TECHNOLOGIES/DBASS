...
CREATE TABLE `student` (
  ...
  `AVAILABILITY2` datetime DEFAULT NULL,
  `AVAILABILITY3` datetime DEFAULT NULL,
  ...
  `FRIENDS1` varchar(50) DEFAULT NULL,
  `FRIENDS2` varchar(50) DEFAULT NULL,
  `FRIENDS3` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`EMAIL`)
